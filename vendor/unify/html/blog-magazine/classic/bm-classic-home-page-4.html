    ...
    <main>
      ...
      <div class="clearfix">
        <div class="row no-gutters">
          <div class="col-md-6">
            <!-- Article -->
            <div class="g-flex-centered g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-primary-opacity-0_2--after text-center g-px-50 g-px-100--lg" style="background-image: url(assets/img-temp/500x450/img8.jpg);" data-calc-target="#js-header">
              <article class="g-pos-rel g-z-index-1">
                <span class="d-inline-block g-color-white g-font-weight-600 g-font-size-16 text-uppercase mb-3">Art</span>
                <h1 class="h1 g-color-white g-font-weight-700 g-mb-35">A Room Gets Colored After More Than 5 Years of its Existing</h1>
          ...
          <div class="col-md-6">
            <!-- Article -->
            <div class="g-flex-centered g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-primary-opacity-0_2--after text-center g-px-50 g-px-100--lg" style="background-image: url(assets/img-temp/500x450/img9.jpg);" data-calc-target="#js-header">
              <article class="g-pos-rel g-z-index-1">
                <span class="d-inline-block g-color-white g-font-weight-600 g-font-size-16 text-uppercase mb-3">Travel</span>
                <h2 class="h1 g-color-white g-font-weight-700 g-mb-35">What the Mystery Writer S.Grafton Can’t Travel Without</h2>
                <a class="btn u-btn-primary g-color-white g-font-weight-700 g-font-size-13 text-uppercase rounded g-py-12 g-px-20" href="bm-classic-single-2.html">Read More</a>
              </article>
            </div>
            <!-- End Article -->
          ...
          <div class="col-lg-9 g-mb-50 g-mb-0--lg">
            ...
            <article class="text-center g-mb-100">
              ...
              <div class="g-px-50 g-px-100--md mb-4">
                <h2 class="h3 mb-4"><a class="u-link-v5 g-color-main g-color-primary--hover" href="#">Editta Sherman Gets Her Due at the New-York Historical Society</a></h2>
            ...
            <article class="text-center g-mb-100">
              <figure class="g-pos-rel mb-5">
                <img class="img-fluid" src="assets/img-temp/900x450/img1.jpg" alt="Image Description">
            ...
            <article class="text-center g-mb-100">
              <figure class="g-pos-rel mb-5">
                <img class="img-fluid" src="assets/img-temp/900x450/img5.jpg" alt="Image Description">
            ...
            <article class="text-center g-mb-100">
              <figure class="g-pos-rel mb-5">
                <img class="img-fluid" src="assets/img-temp/900x450/img6.jpg" alt="Image Description">
